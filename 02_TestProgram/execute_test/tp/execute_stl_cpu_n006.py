#----------------------------------------------------------------------------------------------
# function name : execute_stl_cpu_n006
# description   : Run tp name
# input         : tp's name
# output        : None
#----------------------------------------------------------------------------------------------
def execute_stl_cpu_n006(tp_name) :

    setup_debug(tp_name)

    # Start testing for CPU_N006
    log_message("=================================")
    log_message("= Test Case: STL_CPU_N006")
    ...
    # Start testing for TEST ELEMENT 31
    log_message("=    TEST ELEMENT 31:")
    if not check_testpoint(M33_STL_TE31_EXP_VAL1, 1): return False
