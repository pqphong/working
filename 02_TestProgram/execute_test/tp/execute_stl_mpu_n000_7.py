#----------------------------------------------------------------------------------------------
# function name : execute_stl_mpu_n000_7
# description   : Run tp name
# input         : tp's name
# output        : None
#----------------------------------------------------------------------------------------------
def execute_stl_mpu_n000_7(tp_name) :

    setup_debug(tp_name)

    # Start testing for MPU
    log_message("=================================")
    log_message("= Test Case: STL_MPU_N000 for Region 7")
    ...
    if not check_mpu_region_id("00000007"): return False
