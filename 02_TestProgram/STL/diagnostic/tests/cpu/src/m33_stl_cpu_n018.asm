...
m33_stl_te278:
        ...
        ldr             r4, =M33_STL_TE278_INPUT_VAL5

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE278_INPUT_VAL1
        ...
        ldr             r12, =M33_STL_TE278_EXP_VAL4

        bl              m33_stl_compare_gpr

        vmov            r11, s6

        ldr             r12, =M33_STL_TE278_EXP_VAL2

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE278_INPUT_VAL2
        ...
        ldr             r12, =M33_STL_TE278_EXP_VAL3

        bl              m33_stl_compare_gpr

        vmov            r11, s6

        ldr             r12, =M33_STL_TE278_EXP_VAL1

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE278_INPUT_VAL3
        ...
        ldr             r5, =M33_STL_TE278_INPUT_VAL4
        ...
        ldr             r5, =M33_STL_TE278_INPUT_VAL6
        ...
        ldr             r12, =M33_STL_TE278_EXP_VAL5
...
m33_stl_te293:
        ...
        ldr             r4, =M33_STL_TE293_INPUT_VAL5

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE293_INPUT_VAL1
        ...
        ldr             r12, =M33_STL_TE293_EXP_VAL3

        bl              m33_stl_compare_gpr

        vmov            r11, s6

        ldr             r12, =M33_STL_TE293_EXP_VAL1

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE293_INPUT_VAL2
        ...
        ldr             r12, =M33_STL_TE293_EXP_VAL4

        bl              m33_stl_compare_gpr

        vmov            r11, s6

        ldr             r12, =M33_STL_TE293_EXP_VAL2

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE293_INPUT_VAL3
        ...
        ldr             r5, =M33_STL_TE293_INPUT_VAL4
        ...
        ldr             r5, =M33_STL_TE293_INPUT_VAL6
        ...
        ldr             r12, =M33_STL_TE293_EXP_VAL5
...
m33_stl_te300:
        ...
        ldr             r4, =M33_STL_TE300_INPUT_VAL5

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE300_INPUT_VAL1
        ...
        ldr             r12, =M33_STL_TE300_EXP_VAL3

        bl              m33_stl_compare_gpr

        vmov            r11, s6

        ldr             r12, =M33_STL_TE300_EXP_VAL1

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE300_INPUT_VAL2
        ...
        ldr             r12, =M33_STL_TE300_EXP_VAL2

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE300_INPUT_VAL3
        ...
        ldr             r12, =M33_STL_TE300_EXP_VAL4
        ...
        ldr             r5, =M33_STL_TE300_INPUT_VAL4
        ...
        ldr             r5, =M33_STL_TE300_INPUT_VAL6
        ...
        ldr             r12, =M33_STL_TE300_EXP_VAL5
...
m33_stl_te303:
        ...
        ldr             r4, =M33_STL_TE303_INPUT_VAL5

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE303_INPUT_VAL1
        ...
        ldr             r12, =M33_STL_TE303_EXP_VAL4

        bl              m33_stl_compare_gpr

        vmov            r11, s6

        ldr             r12, =M33_STL_TE303_EXP_VAL2

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE303_INPUT_VAL2
        ...
        ldr             r12, =M33_STL_TE303_EXP_VAL3

        bl              m33_stl_compare_gpr

        vmov            r11, s6

        ldr             r12, =M33_STL_TE303_EXP_VAL1

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE303_INPUT_VAL3
        ...
        ldr             r5, =M33_STL_TE303_INPUT_VAL4
        ...
        ldr             r5, =M33_STL_TE303_INPUT_VAL6
        ...
        ldr             r12, =M33_STL_TE303_EXP_VAL5
...
m33_stl_te306:
        ...
        ldr             r4, =M33_STL_TE306_INPUT_VAL5

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE306_INPUT_VAL1
        ...
        ldr             r12, =M33_STL_TE306_EXP_VAL4

        bl              m33_stl_compare_gpr

        vmov            r11, s6

        ldr             r12, =M33_STL_TE306_EXP_VAL2

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE306_INPUT_VAL2
        ...
        ldr             r12, =M33_STL_TE306_EXP_VAL1

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE306_INPUT_VAL3
        ...
        ldr             r5, =M33_STL_TE306_INPUT_VAL4
        ...
        ldr             r5, =M33_STL_TE306_INPUT_VAL6
        ...
        ldr             r12, =M33_STL_TE306_EXP_VAL3

        bl              m33_stl_compare_gpr

        vmov            r11, s6

        ldr             r12, =M33_STL_TE306_EXP_VAL5
