...
m33_stl_te20:
        ...
        ldr             r6, =M33_STL_TE20_INPUT_VAL1
        ldr             r5, =M33_STL_TE20_INPUT_VAL2

        muls            r5, r6, r5

        mov             r11, r5

        ldr             r7, =M33_STL_TE20_EXP_VAL1

        mov             r12, r7

        bl              m33_stl_compare_gpr

        ldr             r6, =M33_STL_TE20_INPUT_VAL3
        ldr             r5, =M33_STL_TE20_INPUT_VAL4

        muls            r5, r6, r5

        mov             r11, r5

        ldr             r7, =M33_STL_TE20_EXP_VAL2

        mov             r12, r7

        bl              m33_stl_compare_gpr

        ldr             r6, =M33_STL_TE20_INPUT_VAL5
        ldr             r5, =M33_STL_TE20_INPUT_VAL6

        muls            r5, r6, r5

        mov             r11, r5

        ldr             r7, =M33_STL_TE20_EXP_VAL3

        mov             r12, r7

        bl              m33_stl_compare_gpr

        ldr             r6, =M33_STL_TE20_INPUT_VAL6
        ldr             r5, =M33_STL_TE20_INPUT_VAL7

        muls            r5, r6, r5

        mov             r11, r5

        ldr             r7, =M33_STL_TE20_EXP_VAL4
...
m33_stl_te21:
        ...
        ldr             r6, =M33_STL_TE21_INPUT_VAL2

        rsbs            r5, r6, #M33_STL_TE21_INPUT_VAL1

        mov             r11, r5

        ldr             r7, =M33_STL_TE21_EXP_VAL1

        mov             r12, r7

        bl              m33_stl_compare_gpr

        ldr             r6, =M33_STL_TE21_INPUT_VAL3

        rsbs            r5, r6, #M33_STL_TE21_INPUT_VAL1

        mov             r11, r5

        ldr             r7, =M33_STL_TE21_EXP_VAL2

        mov             r12, r7

        bl              m33_stl_compare_gpr

        ldr             r6, =M33_STL_TE21_INPUT_VAL4

        rsbs            r5, r6, #M33_STL_TE21_INPUT_VAL1

        mov             r11, r5

        ldr             r7, =M33_STL_TE21_EXP_VAL3

        mov             r12, r7

        bl              m33_stl_compare_gpr

        ldr             r6, =M33_STL_TE21_INPUT_VAL5

        rsbs            r5, r6, #M33_STL_TE21_INPUT_VAL1

        mov             r11, r5

        ldr             r7, =M33_STL_TE21_EXP_VAL4
...
m33_stl_te22:
        ...
        ldr             r5, =M33_STL_TE22_INPUT_VAL1
        ldr             r6, =M33_STL_TE22_INPUT_VAL2

        rors            r5, r5, r6

        mov             r11, r5

        ldr             r7, =M33_STL_TE22_EXP_VAL1

        mov             r12, r7

        bl              m33_stl_compare_gpr

        ldr             r5, =M33_STL_TE22_INPUT_VAL3
        ldr             r6, =M33_STL_TE22_INPUT_VAL2
        ...
        ldr             r7, =M33_STL_TE22_EXP_VAL2

        mov             r12, r7

        bl              m33_stl_compare_gpr

        ldr             r5, =M33_STL_TE22_INPUT_VAL2
        ldr             r6, =M33_STL_TE22_INPUT_VAL4

        rors            r5, r5, r6

        mov             r11, r5

        ldr             r7, =M33_STL_TE22_EXP_VAL3
...
m33_stl_te23:
        ...
        ldr             r5, =M33_STL_TE23_INPUT_VAL1
        ldr             r6, =M33_STL_TE23_INPUT_VAL2

        sbcs            r5, r5, r6

        mov             r11, r5

        ldr             r7, =M33_STL_TE23_EXP_VAL1

        mov             r12, r7

        bl              m33_stl_compare_gpr

        ldr             r5, =M33_STL_TE23_INPUT_VAL3
        ldr             r6, =M33_STL_TE23_INPUT_VAL4

        sbcs            r5, r5, r6

        mov             r11, r5

        ldr             r7, =M33_STL_TE23_EXP_VAL2

        mov             r12, r7

        bl              m33_stl_compare_gpr

        ldr             r5, =M33_STL_TE23_INPUT_VAL5
        ldr             r6, =M33_STL_TE23_INPUT_VAL6

        sbcs            r5, r5, r6

        mov             r11, r5

        ldr             r7, =M33_STL_TE23_EXP_VAL3
...
m33_stl_te24:
        ...
        ldr             r6, =M33_STL_TE24_INPUT_VAL1

        subs            r5, r6, M33_STL_TE24_INPUT_VAL2

        mov             r11, r5

        ldr             r7, =M33_STL_TE24_EXP_VAL1

        mov             r12, r7

        bl              m33_stl_compare_gpr

        ldr             r6, =M33_STL_TE24_INPUT_VAL3

        subs            r5, r6, M33_STL_TE24_INPUT_VAL4

        mov             r11, r5

        ldr             r7, =M33_STL_TE24_EXP_VAL2

        mov             r12, r7

        bl              m33_stl_compare_gpr

        ldr             r6, =M33_STL_TE24_INPUT_VAL5

        subs            r5, r6, M33_STL_TE24_INPUT_VAL6

        mov             r11, r5

        ldr             r7, =M33_STL_TE24_EXP_VAL3
...
m33_stl_te25:
        ...
        ldr             r5, =M33_STL_TE25_INPUT_VAL1

        subs            r5, r5, M33_STL_TE25_INPUT_VAL2

        mov             r11, r5

        ldr             r7, =M33_STL_TE25_EXP_VAL1

        mov             r12, r7

        bl              m33_stl_compare_gpr

        ldr             r5, =M33_STL_TE25_INPUT_VAL3

        subs            r5, r5, M33_STL_TE25_INPUT_VAL4

        mov             r11, r5

        ldr             r7, =M33_STL_TE25_EXP_VAL2

        mov             r12, r7

        bl              m33_stl_compare_gpr

        ldr             r5, =M33_STL_TE25_INPUT_VAL5

        subs            r5, r5, M33_STL_TE25_INPUT_VAL6

        mov             r11, r5

        ldr             r7, =M33_STL_TE25_EXP_VAL3
...
m33_stl_te26:
        ...
        ldr             r4, =M33_STL_TE26_INPUT_VAL1
        ldr             r6, =M33_STL_TE26_INPUT_VAL2

        subs            r5, r4, r6

        mov             r11, r5

        ldr             r7, =M33_STL_TE26_EXP_VAL1

        mov             r12, r7

        bl              m33_stl_compare_gpr

        ldr             r4, =M33_STL_TE26_INPUT_VAL3
        ldr             r6, =M33_STL_TE26_INPUT_VAL4

        subs            r5, r4, r6

        mov             r11, r5

        ldr             r7, =M33_STL_TE26_EXP_VAL2

        mov             r12, r7

        bl              m33_stl_compare_gpr

        ldr             r4, =M33_STL_TE26_INPUT_VAL5
        ldr             r6, =M33_STL_TE26_INPUT_VAL6

        subs            r5, r4, r6

        mov             r11, r5

        ldr             r7, =M33_STL_TE26_EXP_VAL3
