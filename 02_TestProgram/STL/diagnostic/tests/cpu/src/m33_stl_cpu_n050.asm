...
m33_stl_te296:
        ...
        ldr             r4, =M33_STL_TE296_INPUT_VAL5

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE296_INPUT_VAL1
        ...
        ldr             r12, =M33_STL_TE296_EXP_VAL1

        bl              m33_stl_compare_gpr

        vmov            r11, s6

        ldr             r12, =M33_STL_TE296_EXP_VAL2

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE296_INPUT_VAL2
        ...
        ldr             r12, =M33_STL_TE296_EXP_VAL3

        bl              m33_stl_compare_gpr

        vmov            r11, s6

        ldr             r12, =M33_STL_TE296_EXP_VAL4

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE296_INPUT_VAL3
        ...
        ldr             r12, =M33_STL_TE296_EXP_VAL5

        bl              m33_stl_compare_gpr

        vmov            r11, s6

        ldr             r12, =M33_STL_TE296_EXP_VAL6

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE296_INPUT_VAL4
        ...
        ldr             r12, =M33_STL_TE296_EXP_VAL7

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE296_INPUT_VAL5
        ...
        ldr             r5, =M33_STL_TE296_INPUT_VAL6
        ...
        ldr             r12, =M33_STL_TE296_EXP_VAL8
...
m33_stl_te320:
        ...
        ldr             r4, =M33_STL_TE320_INPUT_VAL5

        vmsr            fpscr, r4

        vmov            s6, r4

        ldr             r5, =M33_STL_TE320_INPUT_VAL1
        ...
        ldr             r12, =M33_STL_TE320_EXP_VAL1

        bl              m33_stl_compare_gpr

        vmov            r11, s6

        ldr             r12, =M33_STL_TE320_EXP_VAL2

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE320_INPUT_VAL2
        ...
        ldr             r12, =M33_STL_TE320_EXP_VAL3

        bl              m33_stl_compare_gpr

        vmov            r11, s6

        ldr             r12, =M33_STL_TE320_EXP_VAL8

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE320_INPUT_VAL3
        ...
        ldr             r12, =M33_STL_TE320_EXP_VAL5

        bl              m33_stl_compare_gpr

        vmov            r11, s6

        ldr             r12, =M33_STL_TE320_EXP_VAL6

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE320_INPUT_VAL4
        ...
        ldr             r12, =M33_STL_TE320_EXP_VAL4

        bl              m33_stl_compare_gpr

        vmov            r11, s6

        ldr             r12, =M33_STL_TE320_EXP_VAL7

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE320_INPUT_VAL5
        ...
        ldr             r5, =M33_STL_TE320_INPUT_VAL6
