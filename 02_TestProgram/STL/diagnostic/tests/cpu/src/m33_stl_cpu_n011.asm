...
m33_stl_te47:
        ...
        ldr             r6, =M33_STL_TE47_INPUT_VAL1

        sxth            r5, r6

        mov             r11, r5

        ldr             r7, =M33_STL_TE47_EXP_VAL1

        mov             r12, r7

        bl              m33_stl_compare_gpr

        ldr             r6, =M33_STL_TE47_INPUT_VAL2

        sxth            r5, r6

        mov             r11, r5

        ldr             r7, =M33_STL_TE47_EXP_VAL2
...
m33_stl_te48:
        ...
        ldr             r6, =M33_STL_TE48_INPUT_VAL1

        sxtb            r5, r6

        mov             r11, r5

        ldr             r7, =M33_STL_TE48_EXP_VAL1

        mov             r12, r7

        bl              m33_stl_compare_gpr

        ldr             r6, =M33_STL_TE48_INPUT_VAL2

        sxtb            r5, r6

        mov             r11, r5

        ldr             r7, =M33_STL_TE48_EXP_VAL2
...
m33_stl_te49:
        ...
        ldr             r6, =M33_STL_TE49_INPUT_VAL1

        uxth            r5, r6

        mov             r11, r5

        ldr             r7, =M33_STL_TE49_EXP_VAL1

        mov             r12, r7

        bl              m33_stl_compare_gpr

        ldr             r6, =M33_STL_TE49_INPUT_VAL2

        uxth            r5, r6

        mov             r11, r5

        ldr             r7, =M33_STL_TE49_EXP_VAL2
...
m33_stl_te50:
        ...
        ldr             r6, =M33_STL_TE50_INPUT_VAL1

        uxtb            r5, r6

        mov             r11, r5

        ldr             r7, =M33_STL_TE50_EXP_VAL1

        mov             r12, r7

        bl              m33_stl_compare_gpr

        ldr             r6, =M33_STL_TE50_INPUT_VAL2

        uxtb            r5, r6

        mov             r11, r5

        ldr             r7, =M33_STL_TE50_EXP_VAL2
...
m33_stl_te51:
        ...
        ldr             r6, =M33_STL_TE51_INPUT_VAL1

        rev             r5, r6

        mov             r11, r5

        ldr             r7, =M33_STL_TE51_EXP_VAL1

        mov             r12, r7

        bl              m33_stl_compare_gpr

        ldr             r6, =M33_STL_TE51_INPUT_VAL2

        rev             r5, r6

        mov             r11, r5

        ldr             r7, =M33_STL_TE51_EXP_VAL2
...
m33_stl_te52:
        ...
        ldr             r6, =M33_STL_TE52_INPUT_VAL1

        rev16           r5, r6

        mov             r11, r5

        ldr             r7, =M33_STL_TE52_EXP_VAL1

        mov             r12, r7

        bl              m33_stl_compare_gpr

        ldr             r6, =M33_STL_TE52_INPUT_VAL2

        rev16           r5, r6

        mov             r11, r5

        ldr             r7, =M33_STL_TE52_EXP_VAL2
...
m33_stl_te53:
        ...
        ldr             r6, =M33_STL_TE53_INPUT_VAL1

        revsh           r5, r6

        mov             r11, r5

        ldr             r7, =M33_STL_TE53_EXP_VAL1

        mov             r12, r7

        bl              m33_stl_compare_gpr

        ldr             r6, =M33_STL_TE53_INPUT_VAL2

        revsh           r5, r6

        mov             r11, r5

        ldr             r7, =M33_STL_TE53_EXP_VAL2
