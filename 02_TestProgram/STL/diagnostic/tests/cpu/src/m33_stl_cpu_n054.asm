...
m33_stl_te281:
        ...
        ldr             r4, =M33_STL_TE281_INPUT_VAL5

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE281_INPUT_VAL1
        ...
        ldr             r12, =M33_STL_TE281_EXP_VAL1

        bl              m33_stl_compare_gpr

        vmov            r11, s6

        ldr             r12, =M33_STL_TE281_EXP_VAL2

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE281_INPUT_VAL2
        ...
        ldr             r12, =M33_STL_TE281_EXP_VAL3

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE281_INPUT_VAL3
        ...
        ldr             r12, =M33_STL_TE281_EXP_VAL4

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE281_INPUT_VAL4
        ...
        ldr             r12, =M33_STL_TE281_EXP_VAL5

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr             r5, =M33_STL_TE281_INPUT_VAL5
        ...
        ldr             r12, =M33_STL_TE281_EXP_VAL6
