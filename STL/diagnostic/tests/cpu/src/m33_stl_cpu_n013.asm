...
#include "m33_stl_datavect_Data.h"
        ...
        public m33_stl_cpu_n013
        section .text:CODE
#endif
#ifdef __WINDRIVER__
        .file           "m33_stl_cpu_n013.asm"
        .section        .s_m33_stl_cpu_n013,"ax",%progbits
        .global         m33_stl_cpu_n013
        .p2align        2
#endif
#ifdef TASKING
...
#else
        adr.w           r3, error_m33_stl_cpu_n013
#endif
...
#ifdef __IAR__
        extern          DATA_VECT_VFMAF32_0
        extern          m33_stl_vfmaf32_test
#endif
#ifdef TASKING
        .extern          DATA_VECT_VFMAF32_0
        .extern          m33_stl_vfmaf32_test
