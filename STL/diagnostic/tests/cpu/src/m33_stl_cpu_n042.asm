...
#include "m33_stl_datavect_Data.h"
        ...
        public m33_stl_cpu_n042
        section .text:CODE
#endif
#ifdef __WINDRIVER__
        .file           "m33_stl_cpu_n042.asm"
        .section        .s_m33_stl_cpu_n042,"ax",%progbits
        .global         m33_stl_cpu_n042
        .p2align        2
#endif
#ifdef TASKING
...
#else
        adr.w           r3, error_m33_stl_cpu_n042
#endif
