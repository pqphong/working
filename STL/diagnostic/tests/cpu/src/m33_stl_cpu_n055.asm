...
#include "m33_stl_constants.h"
        ...
        public m33_stl_cpu_n055
        section .text:CODE
#endif
#ifdef __WINDRIVER__
        .file           "m33_stl_cpu_n055.asm"
        .section        .s_m33_stl_cpu_n055,"ax",%progbits
        .global         m33_stl_cpu_n055
        .p2align        2
#endif
#ifdef TASKING
...
#else
        adr.w           r3, error_m33_stl_cpu_n055
#endif
...
// This TE tests VNMLS.F32 instruction with RP mode
...
m33_stl_te333:
        ...
        ldr.w           r4, =M33_STL_TE333_INPUT_VAL1

        vmsr            fpscr, r4

        ldr.w           r5, =M33_STL_TE333_INPUT_VAL2
        ldr.w           r6, =M33_STL_TE333_INPUT_VAL3
        ldr.w           r7, =M33_STL_TE333_INPUT_VAL2
        ...
        ldr.w           r12, =M33_STL_TE333_EXP_VAL1

        bl              m33_stl_compare_gpr

        vmov            r11, s11

        ldr.w           r12, =M33_STL_TE333_EXP_VAL2

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr.w           r5, =M33_STL_TE333_INPUT_VAL5
        ldr.w           r6, =M33_STL_TE333_INPUT_VAL5
        ldr.w           r7, =M33_STL_TE333_INPUT_VAL4
        ...
        ldr.w           r12, =M33_STL_TE333_EXP_VAL3

        bl              m33_stl_compare_gpr

        vmov            r11, s11

        ldr.w           r12, =M33_STL_TE333_EXP_VAL4

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr.w           r5, =M33_STL_TE333_INPUT_VAL7
        ldr.w           r6, =M33_STL_TE333_INPUT_VAL8
        ldr.w           r7, =M33_STL_TE333_INPUT_VAL6
        ...
        ldr.w           r12, =M33_STL_TE333_EXP_VAL5

        bl              m33_stl_compare_gpr

        vmov            r11, s11

        ldr.w           r12, =M33_STL_TE333_EXP_VAL6
