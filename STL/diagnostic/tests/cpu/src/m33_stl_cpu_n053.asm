...
#include "m33_stl_constants.h"
        ...
        public m33_stl_cpu_n053
        section .text:CODE
#endif
#ifdef __WINDRIVER__
        .file           "m33_stl_cpu_n053.asm"
        .section        .s_m33_stl_cpu_n053,"ax",%progbits
        .global         m33_stl_cpu_n053
        .p2align        2
#endif
#ifdef TASKING
...
#else
        adr.w           r3, error_m33_stl_cpu_n053
#endif
...
// This TE tests VNMLA.F32 instruction with RZ mode
...
m33_stl_te334:
        ...
        ldr.w           r4, =M33_STL_TE334_INPUT_VAL1

        vmsr            fpscr, r4

        ldr.w           r5, =M33_STL_TE334_INPUT_VAL3
        ldr.w           r6, =M33_STL_TE334_INPUT_VAL4
        ldr.w           r7, =M33_STL_TE334_INPUT_VAL2
        ...
        ldr.w           r12, =M33_STL_TE334_EXP_VAL1

        bl              m33_stl_compare_gpr

        vmov            r11, s11

        ldr.w           r12, =M33_STL_TE334_EXP_VAL2

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr.w           r5, =M33_STL_TE334_INPUT_VAL6
        ldr.w           r6, =M33_STL_TE334_INPUT_VAL6
        ldr.w           r7, =M33_STL_TE334_INPUT_VAL5
        ...
        ldr.w           r12, =M33_STL_TE334_EXP_VAL3

        bl              m33_stl_compare_gpr

        vmov            r11, s11

        ldr.w           r12, =M33_STL_TE334_EXP_VAL4

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr.w           r5, =M33_STL_TE334_INPUT_VAL8
        ldr.w           r6, =M33_STL_TE334_INPUT_VAL9
        ldr.w           r7, =M33_STL_TE334_INPUT_VAL7
        ...
        ldr.w           r12, =M33_STL_TE334_EXP_VAL5

        bl              m33_stl_compare_gpr

        vmov            r11, s11

        ldr.w           r12, =M33_STL_TE334_EXP_VAL6
