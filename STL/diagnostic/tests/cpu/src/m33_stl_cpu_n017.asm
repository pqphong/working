...
#include "m33_stl_constants.h"
        ...
        public m33_stl_cpu_n017
        section .text:CODE
#endif
#ifdef __WINDRIVER__
        .file           "m33_stl_cpu_n017.asm"
        .section        .s_m33_stl_cpu_n017,"ax",%progbits
        .global         m33_stl_cpu_n017
        .p2align        2
#endif
#ifdef TASKING
...
#else
        adr.w           r3, error_m33_stl_cpu_n017
#endif
...
m33_stl_te309:
        ...
        ldr.w           r4, =M33_STL_TE309_INPUT_VAL5

        vmsr            fpscr, r4

        ldr.w           r5, =M33_STL_TE309_INPUT_VAL1
        ...
        ldr.w           r12, =M33_STL_TE309_EXP_VAL4

        bl              m33_stl_compare_gpr

        vmov            r11, s6

        ldr.w           r12, =M33_STL_TE309_EXP_VAL2

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr.w           r5, =M33_STL_TE309_INPUT_VAL2
        ...
        ldr.w           r12, =M33_STL_TE309_EXP_VAL3

        bl              m33_stl_compare_gpr

        vmov            r11, s6

        ldr.w           r12, =M33_STL_TE309_EXP_VAL1

        bl              m33_stl_compare_gpr

        vmsr            fpscr, r4

        ldr.w           r5, =M33_STL_TE309_INPUT_VAL3
        ...
        ldr.w           r5, =M33_STL_TE309_INPUT_VAL4
        ...
        ldr.w           r5, =M33_STL_TE309_INPUT_VAL6
        ...
        ldr.w           r12, =M33_STL_TE309_EXP_VAL5
