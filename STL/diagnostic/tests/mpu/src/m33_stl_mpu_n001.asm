...
#include "m33_stl_registerInfo.h"
        ...
        extern          m33_stl_mpuRegisterInfo

        public m33_stl_mpu_n001
        section .text:CODE
#endif
#ifdef __WINDRIVER__
        .file           "m33_stl_mpu_n001.asm"
        .section        .s_m33_stl_mpu_n001,"ax",%progbits
        .global         m33_stl_mpu_n001
        .p2align        2
#endif
#ifdef TASKING
...
#else
        adr.w           r3, error_m33_stl_mpu_n001
#endif
...
m33_stl_te271:
        ...
        ldr.w           r5, =m33_stl_mpuRegisterInfo
        ldr.w           r6, =M33_STL_MPU_TOT_REGS

        ldr.w           r7, =M33_STL_TE271_INPUT_VAL1
